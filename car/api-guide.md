...
- The **Lease-a-car API** is built using Java 21+ w/ Springboot 3.x or 4.x
...
- Documentation is provided in the [README.md](api-guide.md) on how the API works, and **how to run it**.
